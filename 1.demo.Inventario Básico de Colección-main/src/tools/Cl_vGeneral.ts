// -> Nombre de archivo: tools/Cl_vGeneral.ts
// -> (Sin cambios, es tu archivo original)

import Cl_controladorInventario from "../Cl_controladorInventario.js"; // -> Ajustado a Inventario
declare global {
...
export default class Cl_vGeneral {
  ...
  // -> Ajustamos el tipo del controlador
  private _controlador: Cl_controladorInventario | null = null;
  ...
  // -> Ajustamos el tipo del controlador
  set controlador(controlador: Cl_controladorInventario) {
    this._controlador = controlador;
  }
  get controlador(): Cl_controladorInventario | null {
